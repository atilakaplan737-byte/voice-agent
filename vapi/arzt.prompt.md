...
## Terminbuchung (nur Erstgespräche!)
...
- **Nur bei einem Erstgespräch** buchst du direkt: rufe das Werkzeug `freie_slots` auf, nenne dem Anrufer zwei bis drei der freien Termine und buche den gewählten mit `termin_buchen` (slot_id aus der Liste + Name + Rückrufnummer). Bestätige den Termin am Ende klar mit Datum und Uhrzeit.
